...
Version  : 2025.05.18
Release  : 54
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/ISOcodes_2025.05.18.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/ISOcodes_2025.05.18.tar.gz
...
popd
pushd ..
cp -a ISOcodes buildavx512
popd
pushd ..
cp -a ISOcodes buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747667747
